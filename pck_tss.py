...
def get_smooth(img, mask=None):
    """
    Calculate the smoothness of an image based on its gradients.

    Args:
        img (torch.Tensor): Input image tensor.
        mask (torch.Tensor, optional): Mask tensor for image. Defaults to None.

    Returns:
        torch.Tensor: Smoothness value of the image.
    """
    ...
    def _gradient_x(img,mask): #to be implemented
